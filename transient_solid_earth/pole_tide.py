...
def pole_motion_correction(
    ...
    return (
        stokes_to_ewh_factor * fft(coherent_pole_motion.real),  # C_2_1 frequencial correction.
        stokes_to_ewh_factor * fft(coherent_pole_motion.imag),  # S_2_1 frequencial correction.
    )
