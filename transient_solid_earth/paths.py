...
solid_earth_model_descriptions_base_path = data_path.joinpath("solid_earth_model_descriptions")
solid_earth_model_descriptions_path: dict[SolidEarthModelPart, Path] = {
    model_part: solid_earth_model_descriptions_base_path.joinpath(model_part.name)
